...
Plans:
- [x] 02-01-PLAN.md — UUID Auth Flow (TokenService schoolUUID, FindByUUID in AuthRepository)
- [x] 02-02-PLAN.md — Core Repository UUID + SchoolConnection (depends on 02-01)
